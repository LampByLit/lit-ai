              ...
              <div style={{ 
                ...
                <div style={{
                  ...
                  <p style={{ 
                    ...
                    This project is open source and can be downloaded at <a href="https://github.com/LampByLit/lit-ai" style={{color: '#ffcd42'}}>github.com/LampByLit/lit-ai</a>.
                  </p>
                  <p style={{ 
                    fontSize: 'clamp(0.5rem, 1.35vw, 0.85rem)', 
                    opacity: 0.8,
                    ...
                    To support and expand this project and others like it, <a href="https://www.patreon.com/Lamp" style={{color: '#ffcd42'}}>please subscribe on Patreon</a>.
                  </p>
                  <p style={{ 
                    fontSize: 'clamp(0.5rem, 1.35vw, 0.85rem)', 
                    opacity: 0.8,
