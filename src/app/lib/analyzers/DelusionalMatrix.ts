...
Pseudointellectual content: ${article.delusionalStats.delusionalComments} out of ${article.delusionalStats.analyzedComments} posts (${article.delusionalStats.percentage.toFixed(2)}%)`;
    }).join('\n\n');
  }
